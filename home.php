...
<div class="containe-fluid">
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php echo "مرحبأ بك  ". $_SESSION['login_name']."!"  ?>
                    <hr>
                    <h4 style="font-size:30px;margin-left:583px; font-style:oblique;"><b>الدم المتاح لكل مجموعة </b></h4>
                    <div class="row">
                        <?php 
                            ...
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        ...
                                        <p><b>الطلبات التي تم تسليمها اليوم</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
